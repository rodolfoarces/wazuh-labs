...
```
curl -L https://raw.githubusercontent.com/rodolfoarces/wazuh-labs/refs/heads/main/wazuh_syscollector_events/syscollector-report.conf -o /var/ossec/wodle/syscollector-report.conf
chmod 640 /var/ossec/wodle/syscollector-report.conf
chown root:wazuh /var/ossec/wodle/syscollector-report.conf
curl -L https://raw.githubusercontent.com/rodolfoarces/wazuh-labs/refs/heads/main/wazuh_syscollector_events/syscollector-report.py -o /var/ossec/wodle/syscollector-report.py
chmod 750 /var/ossec/wodle/syscollector-report.py
chown root:wazuh /var/ossec/wodle/syscollector-report.py
```

The `/var/ossec/wodles/syscollector-report.conf` is to be adjusted acordigly to the Wazuh Server API user.

To execute the Syscollector helper, use the Wazuh Python version present:
